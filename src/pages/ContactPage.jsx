                    ...
                    <div className="space-y-3">
                        {settings.footer_email && (
                            <div className="flex items-center gap-3">
                                ...
                                <a href={mailHref(settings.footer_email, i18n.language === 'sr' ? 'Upit sa sajta' : 'Inquiry from the website')} className="text-sm text-gray-600 hover:text-black transition-colors">
                                    {settings.footer_email}
                                </a>
                            </div>
                        )}
                        {settings.footer_phone && (
                            <div className="flex items-center gap-3">
                                ...
                                <a href={telHref(settings.footer_phone)} className="text-sm text-gray-600 hover:text-black transition-colors whitespace-nowrap">
                                    {settings.footer_phone}
                                </a>
                            </div>
                        )}
